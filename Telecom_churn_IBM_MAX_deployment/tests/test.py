...
def test_swagger():
    ...
    model_endpoint = 'http://192.168.99.100:5000/swagger.json'
...
def test_metadata():
    ...
    model_endpoint = 'http://192.168.99.100:5000/model/metadata'
...
def test_response():
    model_endpoint = 'http://192.168.99.100:5000/model/predict'
